    ...
    <div className="min-h-screen bg-gradient-to-br from-sage-50 via-terracotta-50 to-earth-50">
      ...
      <section className="relative pt-20 pb-16 px-4 overflow-hidden">
        ...
        <div className="relative max-w-6xl mx-auto text-center">
          ...
          <h1 className="font-playfair text-5xl md:text-7xl font-bold text-earth-900 mb-6 animate-fade-in">
            Cartomanti.online
          </h1>

          <p className="text-xl md:text-2xl text-earth-700 mb-8 max-w-3xl mx-auto leading-relaxed">
            Consulti di cartomanzia professionale al telefono. I nostri esperti cartomanti sono disponibili 24/7 per
            guidarti nel tuo cammino. I primi 15 minuti sono gratuiti per ogni nuovo utente.
          </p>
      ...
      <section className="py-16 px-4 bg-gradient-to-r from-earth-100 to-sage-100">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <Card className="bg-white/80 backdrop-blur-sm shadow-lg hover:shadow-xl transition-all duration-300 floating">
              <CardContent className="p-6 text-center">
                <div className="text-4xl mb-4">💔</div>
                <h3 className="font-semibold text-earth-800 mb-2">Problemi d'Amore</h3>
                <p className="text-earth-600">Relazioni complicate, dubbi sul futuro sentimentale</p>
              </CardContent>
            </Card>

            <Card
              className="bg-white/80 backdrop-blur-sm shadow-lg hover:shadow-xl transition-all duration-300 floating"
              style={{ animationDelay: "0.2s" }}
            >
              <CardContent className="p-6 text-center">
                <div className="text-4xl mb-4">💼</div>
                <h3 className="font-semibold text-earth-800 mb-2">Carriera e Lavoro</h3>
                <p className="text-earth-600">Decisioni professionali, cambiamenti lavorativi</p>
              </CardContent>
            </Card>
            ...
            >
              <CardContent className="p-6 text-center">
                <div className="text-4xl mb-4">🌟</div>
                <h3 className="font-semibold text-earth-800 mb-2">Crescita Personale</h3>
                <p className="text-earth-600">Scoprire il tuo potenziale, superare ostacoli</p>
              </CardContent>
            </Card>
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-earth-700 max-w-3xl mx-auto">
              I nostri cartomanti esperti ti offrono consulti personalizzati e accurati, disponibili immediatamente al
              telefono.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center group">
              ...
              <h3 className="font-semibold text-earth-800 mb-2">Chiamata Immediata</h3>
              <p className="text-earth-600">Connessione istantanea con i nostri esperti</p>
            </div>
            ...
            <div className="text-center group">
              ...
              <h3 className="font-semibold text-earth-800 mb-2">Totale Riservatezza</h3>
              <p className="text-earth-600">I tuoi segreti sono al sicuro con noi</p>
            </div>
            ...
            <div className="text-center group">
              ...
              <h3 className="font-semibold text-earth-800 mb-2">Cartomanti Certificati</h3>
              <p className="text-earth-600">Oltre 20 anni di esperienza media</p>
            </div>
            ...
            <div className="text-center group">
              ...
              <h3 className="font-semibold text-earth-800 mb-2">Letture Accurate</h3>
              <p className="text-earth-600">Previsioni precise e consigli pratici</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-4 bg-gradient-to-br from-sage-50 to-terracotta-50">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="font-playfair text-4xl font-bold text-earth-900 mb-6">Come Funziona</h2>
            <p className="text-xl text-earth-700">Tre semplici passi per ottenere le risposte che cerchi</p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center relative">
              ...
              <h3 className="font-semibold text-earth-800 mb-4 text-xl">Scegli il Tuo Piano</h3>
              <p className="text-earth-600">Seleziona il pacchetto di minuti più adatto alle tue esigenze</p>
              {/* Connecting line */}
            ...
            <div className="text-center relative">
              ...
              <h3 className="font-semibold text-earth-800 mb-4 text-xl">Chiama Subito</h3>
              <p className="text-earth-600">Vieni connesso immediatamente con un cartomante disponibile</p>
              {/* Connecting line */}
            ...
            <div className="text-center">
              ...
              <h3 className="font-semibold text-earth-800 mb-4 text-xl">Ricevi le Risposte</h3>
              <p className="text-earth-600">Ottieni consigli personalizzati e previsioni accurate per il tuo futuro</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-4 bg-earth-900 text-white">
        <div className="max-w-6xl mx-auto text-center">
          <h2 className="font-playfair text-3xl font-bold mb-12">Perché Scegliere Cartomanti.online</h2>

          <div className="grid md:grid-cols-4 gap-8">
            <div className="floating">
              <div className="text-4xl font-bold text-sage-400 mb-2">50,000+</div>
              <p className="text-earth-200">Consulti Completati</p>
            </div>
            <div className="floating" style={{ animationDelay: "0.2s" }}>
              <div className="text-4xl font-bold text-terracotta-400 mb-2">24/7</div>
            ...
            <div className="floating" style={{ animationDelay: "0.6s" }}>
              <div className="text-4xl font-bold text-terracotta-400 mb-2">20+</div>
